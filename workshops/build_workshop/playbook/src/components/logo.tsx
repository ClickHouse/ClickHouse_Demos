...
// Official ClickHouse wordmark, taken from the clickhouse.com site header.
// fill="currentColor" so it inherits the theme foreground (light on dark, dark on light).
