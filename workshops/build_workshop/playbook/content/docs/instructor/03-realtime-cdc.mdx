...
[03 Managed Postgres CDC](/docs/learner/03-realtime-cdc).
...
If a participant's org cannot create managed Postgres, hand them a managed-cloud connection slip.
The cloud pool (and the slot/sender caveats that come with it at 30+ scale) is
