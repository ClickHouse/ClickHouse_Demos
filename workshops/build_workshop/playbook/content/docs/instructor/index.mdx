...
| 01 | ClickHouse Cloud | 15 min | First "wow" on query speed |
| 02 | Base app | 5 min | Nothing to build; keep it short |
| 03 | Managed Postgres CDC | 20 min | Each learner creates a managed instance; keep a managed cloud fallback pool |
...
Some fallback resources are shared across the whole room. Confirm each is provisioned and healthy
before doors open:
...
<Cards>
  ...
  <Card title="03 Managed Postgres CDC" href="/docs/instructor/03-realtime-cdc" />
