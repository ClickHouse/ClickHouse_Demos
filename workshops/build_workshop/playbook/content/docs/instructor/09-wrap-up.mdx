...
- Reinforce the take-home: managed ClickHouse, Postgres, ClickPipes, Agents, and ClickStack
  artifacts persist for the trial. The local app and telemetry forwarder restart with Docker.
