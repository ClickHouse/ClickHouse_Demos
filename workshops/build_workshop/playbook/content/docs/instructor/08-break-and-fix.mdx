...
This is the finale; protect enough runway for the diagnosis to land and for a couple of
projector demos. Rough per-fault diagnosis times: fault 02 = 5-10 min, fault 03 =
10-20 min, fault 01 = 5-15 min. Run one fault per participant (or one for the room); when
demonstrating more than one, use the order 02 -> 03 -> 01. TODO: set the module's overall
minute budget and a hard-stop at rehearsal.
