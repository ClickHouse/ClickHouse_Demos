...
You are on `build-workshop-v1` — the complete app you have been configuring all session. If you
checked out a fault branch in module 08, `git checkout build-workshop-v1` returns you here. Budget
about **10 minutes**.
...
- Want a clean slate? Each module names a checkpoint branch, and `git checkout
  build-workshop-v1` returns you to the complete app.
