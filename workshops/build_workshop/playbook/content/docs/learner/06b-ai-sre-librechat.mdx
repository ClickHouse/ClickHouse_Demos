...
- `CLICKSTACK_SERVICE_ID` — your ClickStack **Service ID**. In HyperDX (ClickStack), open
...
*Find `CLICKSTACK_SERVICE_ID` in HyperDX → **Team Settings** → **Data** → **Connections** → **Default** → **Service ID**.*
