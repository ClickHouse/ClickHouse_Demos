...
1. [Base app](/docs/learner/01-base-app) - tour the running app so you know what you are moving onto ClickHouse.
2. [ClickHouse Cloud](/docs/learner/02-clickhouse-cloud) - build the schema and seed 3.2M+ real taxi rows from object storage.
...
7. [Chat and Langfuse](/docs/learner/07-chat-langfuse) - wire an in-app AI chat and trace every turn.
8. [Break and fix](/docs/learner/08-break-and-fix) - inject a fault, diagnose it with the AI SRE, fix it.
...
**$0** - ClickHouse Cloud trial credits cover everything. The only paid key is about **$5 of OpenAI credit** for the chat module (module 07), and even that stretches across many runs.
