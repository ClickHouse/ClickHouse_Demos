...
3. [Managed Postgres CDC](/docs/learner/03-realtime-cdc) - stream ClickHouse-managed Postgres into ClickHouse with a ClickPipe.
...
By the end, your stateful data and observability services run in the cloud. The app,
load generator, client tools, and telemetry forwarder run locally:

- a **live ops dashboard** over **3.2M+ real NYC taxi rows** seeded straight from object storage,
- a **change-data-capture pipeline** streaming ClickHouse-managed Postgres into ClickHouse continuously,
