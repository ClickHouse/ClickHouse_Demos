...
| 07 | 20 min | [Break and fix](/docs/learner/07-break-and-fix) | [notes](/docs/instructor/07-break-and-fix) | `fault/*` | Continue from AI SRE or optional 06b, inject a fault, diagnose it via ClickStack, and apply the fix |
...
- Clone the app once in module 00 and stay on `build-workshop-v1` except while running
