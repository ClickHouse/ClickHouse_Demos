...
| 01 | 5 min | [Base app](/docs/learner/01-base-app) | [notes](/docs/instructor/01-base-app) | `main` | Tour the running app: Ops and Historical dashboards, the chat panel, the data flow |
| 02 | 15 min | [ClickHouse Cloud](/docs/learner/02-clickhouse-cloud) | [notes](/docs/instructor/02-clickhouse-cloud) | `main` | Create the schema, seed historical data from object storage, and feel the query speed |
...
| 06 | 15 min | [AI SRE](/docs/learner/06-ai-sre) | [notes](/docs/instructor/06-ai-sre) | `main` | Connect your agent to the ClickStack MCP and have it build an SRE dashboard and alert |
| 07 | 15 min | [Chat and Langfuse](/docs/learner/07-chat-langfuse) | [notes](/docs/instructor/07-chat-langfuse) | `main` | Use the in-app AI chat and follow its traces, generations, and costs in Langfuse |
