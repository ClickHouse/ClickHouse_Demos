...
**Reference:** [Snowflake vs ClickHouse](https://workshop.demohouse.cloud/docs/snowflake-migration/reference/snowflake-vs-clickhouse) — Section 2 (SQL Dialect Gaps)
