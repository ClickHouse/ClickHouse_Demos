...
**Reference:** [Module 03 — Provision and migrate](https://workshop.demohouse.cloud/docs/snowflake-migration/learner/03-provision-and-migrate) → [Module 04 — Rebuild the dbt pipeline](https://workshop.demohouse.cloud/docs/snowflake-migration/learner/04-rebuild-dbt) → [Module 05 — Benchmark and cutover](https://workshop.demohouse.cloud/docs/snowflake-migration/learner/05-benchmark-and-cutover) for execution order
