...
This directory contains the learner-facing code for the
[Polymarket real-time analytics workshop](https://labs.demohouse.cloud/docs/polymarket).
Start with the hosted playbook rather than this README: it provides the setup sequence,
explanations, expected results, and recovery steps. The workshop reads public market data
only. It does not authenticate to Polymarket, place orders, create wallets, or provide
financial advice.
...
Python storage adapter, applies the schema, and executes the reference queries.
